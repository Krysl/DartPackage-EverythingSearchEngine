...
class EverythingBase {
  ...
  /// write search state
  void SetSearchW(LPCWSTR lpString) {
    return _SetSearchW(lpString);
  }
  ...
  void SetSearchA(LPCSTR lpString) {
    return _SetSearchA(lpString);
  }
  ...
  void SetMatchPath(int bEnable) {
    return _SetMatchPath(bEnable);
  }
  ...
  void SetMatchCase(int bEnable) {
    return _SetMatchCase(bEnable);
  }
  ...
  void SetMatchWholeWord(int bEnable) {
    return _SetMatchWholeWord(bEnable);
  }
  ...
  void SetRegex(int bEnable) {
    return _SetRegex(bEnable);
  }
  ...
  void SetMax(int dwMax) {
    return _SetMax(dwMax);
  }
  ...
  void SetOffset(int dwOffset) {
    return _SetOffset(dwOffset);
  }
  ...
  void SetReplyWindow(HWND hWnd) {
    return _SetReplyWindow(hWnd);
  }
  ...
  void SetReplyID(int dwId) {
    return _SetReplyID(dwId);
  }
  ...
  void SetSort(int dwSort) {
    return _SetSort(dwSort);
  }
  ...
  void SetRequestFlags(int dwRequestFlags) {
    return _SetRequestFlags(dwRequestFlags);
  }
  ...
  late final _GetMatchPathPtr = _lookup<ffi.NativeFunction<BOOL Function()>>(
  ...
  late final _GetMatchCasePtr = _lookup<ffi.NativeFunction<BOOL Function()>>(
  ...
  late final _GetRegexPtr = _lookup<ffi.NativeFunction<BOOL Function()>>(
    'Everything_GetRegex',
  );
  ...
  late final _GetMaxPtr = _lookup<ffi.NativeFunction<DWORD Function()>>(
    'Everything_GetMax',
  );
  ...
  late final _GetOffsetPtr = _lookup<ffi.NativeFunction<DWORD Function()>>(
  ...
  late final _GetSearchAPtr = _lookup<ffi.NativeFunction<LPCSTR Function()>>(
  ...
  late final _GetSearchWPtr = _lookup<ffi.NativeFunction<LPCWSTR Function()>>(
  ...
  late final _GetLastErrorPtr = _lookup<ffi.NativeFunction<DWORD Function()>>(
  ...
  late final _GetReplyWindowPtr = _lookup<ffi.NativeFunction<HWND Function()>>(
  ...
  late final _GetReplyIDPtr = _lookup<ffi.NativeFunction<DWORD Function()>>(
  ...
  late final _GetSortPtr = _lookup<ffi.NativeFunction<DWORD Function()>>(
    'Everything_GetSort',
  );
  ...
  /// execute query
  int QueryA(int bWait) {
    return _QueryA(bWait);
  }

  late final _QueryAPtr = _lookup<ffi.NativeFunction<BOOL Function(BOOL)>>(
    'Everything_QueryA',
  );
  late final _QueryA = _QueryAPtr.asFunction<int Function(int)>();

  int QueryW(int bWait) {
    return _QueryW(bWait);
  }

  late final _QueryWPtr = _lookup<ffi.NativeFunction<BOOL Function(BOOL)>>(
    'Everything_QueryW',
  );
  ...
  int IsQueryReply(int message, int wParam, int lParam, int dwId) {
    return _IsQueryReply(message, wParam, lParam, dwId);
  }
  ...
  late final _GetNumResultsPtr = _lookup<ffi.NativeFunction<DWORD Function()>>(
  ...
  late final _GetTotResultsPtr = _lookup<ffi.NativeFunction<DWORD Function()>>(
    'Everything_GetTotResults',
  );
  late final _GetTotResults = _GetTotResultsPtr.asFunction<int Function()>();

  int IsVolumeResult(int dwIndex) {
    return _IsVolumeResult(dwIndex);
  }
  ...
  int IsFolderResult(int dwIndex) {
    return _IsFolderResult(dwIndex);
  }
  ...
  LPCWSTR GetResultFileNameW(int dwIndex) {
    return _GetResultFileNameW(dwIndex);
  }
  ...
  LPCSTR GetResultFileNameA(int dwIndex) {
    return _GetResultFileNameA(dwIndex);
  }
  ...
  LPCWSTR GetResultPathW(int dwIndex) {
    return _GetResultPathW(dwIndex);
  }
  ...
  LPCSTR GetResultPathA(int dwIndex) {
    return _GetResultPathA(dwIndex);
  }
  ...
  int GetResultFullPathNameA(int dwIndex, LPSTR buf, int bufsize) {
    return _GetResultFullPathNameA(dwIndex, buf, bufsize);
  }
  ...
  int GetResultFullPathNameW(
    ...
    return _GetResultFullPathNameW(dwIndex, wbuf, wbuf_size_in_wchars);
  }
  ...
  LPCWSTR GetResultExtensionW(int dwIndex) {
    return _GetResultExtensionW(dwIndex);
  }
  ...
  LPCSTR GetResultExtensionA(int dwIndex) {
    return _GetResultExtensionA(dwIndex);
  }
  ...
  int GetResultSize(int dwIndex, ffi.Pointer<LARGE_INTEGER> lpSize) {
    return _GetResultSize(dwIndex, lpSize);
  }

  late final _GetResultSizePtr =
      _lookup<
        ffi.NativeFunction<BOOL Function(DWORD, ffi.Pointer<LARGE_INTEGER>)>
      >('Everything_GetResultSize');
  late final _GetResultSize =
      _GetResultSizePtr.asFunction<
        int Function(int, ffi.Pointer<LARGE_INTEGER>)
      >();

  int GetResultDateCreated(int dwIndex, ffi.Pointer<FILETIME> lpDateCreated) {
    return _GetResultDateCreated(dwIndex, lpDateCreated);
  }
  ...
  late final _GetResultDateCreated =
      _GetResultDateCreatedPtr.asFunction<
        int Function(int, ffi.Pointer<FILETIME>)
      >();

  int GetResultDateModified(int dwIndex, ffi.Pointer<FILETIME> lpDateModified) {
    return _GetResultDateModified(dwIndex, lpDateModified);
  }
  ...
  late final _GetResultDateModified =
      _GetResultDateModifiedPtr.asFunction<
        int Function(int, ffi.Pointer<FILETIME>)
      >();

  int GetResultDateAccessed(int dwIndex, ffi.Pointer<FILETIME> lpDateAccessed) {
    return _GetResultDateAccessed(dwIndex, lpDateAccessed);
  }
  ...
  late final _GetResultDateAccessed =
      _GetResultDateAccessedPtr.asFunction<
        int Function(int, ffi.Pointer<FILETIME>)
      >();

  int GetResultAttributes(int dwIndex) {
    return _GetResultAttributes(dwIndex);
  }
  ...
  LPCWSTR GetResultFileListFileNameW(int dwIndex) {
    return _GetResultFileListFileNameW(dwIndex);
  }
  ...
  LPCSTR GetResultFileListFileNameA(int dwIndex) {
    return _GetResultFileListFileNameA(dwIndex);
  }
  ...
  int GetResultRunCount(int dwIndex) {
    return _GetResultRunCount(dwIndex);
  }
  ...
  int GetResultDateRun(int dwIndex, ffi.Pointer<FILETIME> lpDateRun) {
    return _GetResultDateRun(dwIndex, lpDateRun);
  }
  ...
  late final _GetResultDateRun =
      _GetResultDateRunPtr.asFunction<
        int Function(int, ffi.Pointer<FILETIME>)
      >();
  ...
  int GetResultDateRecentlyChanged(
    ...
    return _GetResultDateRecentlyChanged(dwIndex, lpDateRecentlyChanged);
  }
  ...
  late final _GetResultDateRecentlyChanged =
      _GetResultDateRecentlyChangedPtr.asFunction<
        int Function(int, ffi.Pointer<FILETIME>)
      >();

  LPCWSTR GetResultHighlightedFileNameW(int dwIndex) {
    return _GetResultHighlightedFileNameW(dwIndex);
  }
  ...
  LPCSTR GetResultHighlightedFileNameA(int dwIndex) {
    return _GetResultHighlightedFileNameA(dwIndex);
  }
  ...
  LPCWSTR GetResultHighlightedPathW(int dwIndex) {
    return _GetResultHighlightedPathW(dwIndex);
  }
  ...
  LPCSTR GetResultHighlightedPathA(int dwIndex) {
    return _GetResultHighlightedPathA(dwIndex);
  }
  ...
  LPCWSTR GetResultHighlightedFullPathAndFileNameW(int dwIndex) {
    return _GetResultHighlightedFullPathAndFileNameW(dwIndex);
  }
  ...
  LPCSTR GetResultHighlightedFullPathAndFileNameA(int dwIndex) {
    return _GetResultHighlightedFullPathAndFileNameA(dwIndex);
  }
  ...
  late final _ResetPtr = _lookup<ffi.NativeFunction<ffi.Void Function()>>(
    'Everything_Reset',
  );
  ...
  late final _CleanUpPtr = _lookup<ffi.NativeFunction<ffi.Void Function()>>(
    'Everything_CleanUp',
  );
  ...
  late final _GetRevisionPtr = _lookup<ffi.NativeFunction<DWORD Function()>>(
  ...
  late final _ExitPtr = _lookup<ffi.NativeFunction<BOOL Function()>>(
    'Everything_Exit',
  );
  late final _Exit = _ExitPtr.asFunction<int Function()>();

  int MSIExitAndStopService(ffi.Pointer<ffi.Void> msihandle) {
    return _MSIExitAndStopService(msihandle);
  }

  late final _MSIExitAndStopServicePtr =
      _lookup<ffi.NativeFunction<UINT Function(ffi.Pointer<ffi.Void>)>>(
        'Everything_MSIExitAndStopService',
      );
  late final _MSIExitAndStopService =
      _MSIExitAndStopServicePtr.asFunction<
        int Function(ffi.Pointer<ffi.Void>)
      >();

  int MSIStartService(ffi.Pointer<ffi.Void> msihandle) {
    return _MSIStartService(msihandle);
  }

  late final _MSIStartServicePtr =
      _lookup<ffi.NativeFunction<UINT Function(ffi.Pointer<ffi.Void>)>>(
        'Everything_MSIStartService',
      );
  late final _MSIStartService =
      _MSIStartServicePtr.asFunction<int Function(ffi.Pointer<ffi.Void>)>();

  int IsDBLoaded() {
    return _IsDBLoaded();
  }

  late final _IsDBLoadedPtr = _lookup<ffi.NativeFunction<BOOL Function()>>(
  ...
  late final _IsAdminPtr = _lookup<ffi.NativeFunction<BOOL Function()>>(
    'Everything_IsAdmin',
  );
  ...
  late final _IsAppDataPtr = _lookup<ffi.NativeFunction<BOOL Function()>>(
  ...
  late final _RebuildDBPtr = _lookup<ffi.NativeFunction<BOOL Function()>>(
  ...
  late final _SaveDBPtr = _lookup<ffi.NativeFunction<BOOL Function()>>(
    'Everything_SaveDB',
  );
  ...
  late final _SaveRunHistoryPtr = _lookup<ffi.NativeFunction<BOOL Function()>>(
  ...
  int IsFastSort(int sortType) {
    return _IsFastSort(sortType);
  }

  late final _IsFastSortPtr = _lookup<ffi.NativeFunction<BOOL Function(DWORD)>>(
    'Everything_IsFastSort',
  );
  late final _IsFastSort = _IsFastSortPtr.asFunction<int Function(int)>();

  int IsFileInfoIndexed(int fileInfoType) {
    return _IsFileInfoIndexed(fileInfoType);
  }

  late final _IsFileInfoIndexedPtr =
      _lookup<ffi.NativeFunction<BOOL Function(DWORD)>>(
        'Everything_IsFileInfoIndexed',
      );
  late final _IsFileInfoIndexed =
      _IsFileInfoIndexedPtr.asFunction<int Function(int)>();

  int GetRunCountFromFileNameW(LPCWSTR lpFileName) {
    return _GetRunCountFromFileNameW(lpFileName);
  }
  ...
  int GetRunCountFromFileNameA(LPCSTR lpFileName) {
    return _GetRunCountFromFileNameA(lpFileName);
  }
  ...
  int SetRunCountFromFileNameW(LPCWSTR lpFileName, int dwRunCount) {
    return _SetRunCountFromFileNameW(lpFileName, dwRunCount);
  }
  ...
  int SetRunCountFromFileNameA(LPCSTR lpFileName, int dwRunCount) {
    return _SetRunCountFromFileNameA(lpFileName, dwRunCount);
  }
  ...
  int IncRunCountFromFileNameW(LPCWSTR lpFileName) {
    return _IncRunCountFromFileNameW(lpFileName);
  }
  ...
  int IncRunCountFromFileNameA(LPCSTR lpFileName) {
    return _IncRunCountFromFileNameA(lpFileName);
  }
